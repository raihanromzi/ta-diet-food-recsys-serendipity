...
function DietFood() {
    ...
    return (
        <>
            ...
            <p className={"font-sans text-sm font-medium"} style={{color: '#000'}}>Please select foods for Breakfast,
            ...
            <div className="form-responsive mb-10">
                ...
                <div className="grid mt-6 w-full items-start">
                    <div className="grid w-full items-center">
                        <div className="mb-4 text-2xl font-semibold">Calorie Calculator</div>
                        <div className={"font-sans text-sm font-medium -mt-4"} style={{color: '#000'}}>
                            <div className="flex">
