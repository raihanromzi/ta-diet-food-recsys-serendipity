...
function Onboarding() {
    ...
    return (<>
        ...
        <p className={"font-sans text-sm font-medium"} style={{color: '#000'}}>Enter your Age, Weight, Gender,
        ...
        <div>
            <div className="grid mt-10 w-full items-center">
                ...
                <Select className="w-full" onValueChange={(e) => setNumberOfMealsPerDay(e)}>
                    <SelectTrigger>
        ...
        <div className="mt-10 text-right">
            <Button className='rounded-full bg-black px-10' onClick={handleNextClick}>Next</Button>
        </div>
    </>)
}
