...
function TimeToEat() {
    ...
    return (
        <>
            ...
            <p className={"font-sans text-sm font-medium"} style={{color: '#000'}}>Here are the foods you've selected
                and a comparison of calories with what you need.</p>
                ...
                <div className="grid mt-6 w-full items-start mr-6">
                    <div className="grid w-full items-start">
                        <div className="grid w-full items-center">
                            <div className="mb-4 text-xl font-semibold">Calorie Calculator</div>
                            <div className={"font-sans text-sm font-medium -mt-4"} style={{color: '#000'}}>
                                <div className="flex">
